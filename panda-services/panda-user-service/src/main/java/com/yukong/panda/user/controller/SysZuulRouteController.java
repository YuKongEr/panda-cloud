...
import com.yukong.panda.user.model.query.SysZuulRoutesQuery;
...
public class SysZuulRouteController extends BaseController<SysZuulRouteService, SysZuulRoutesQuery, SysZuulRoute, Integer> {
}